...
## -----------------------------------------------------------------------------
ath.info.test <- merge(ath.full.info, athlete_covid_dates %>% select(-MaxHR), by.x="name", by.y="athlete", all = T) %>% 
...
# for (i in "BA_002") {
  ...
  covid_dates <- c(ath.info.test$diagnose_date[ath.info.test$ath.id == i],
                   ...
                   ath.info.test$vax_3[ath.info.test$ath.id == i],
                   ath.info.test$vax_4[ath.info.test$ath.id == i])
